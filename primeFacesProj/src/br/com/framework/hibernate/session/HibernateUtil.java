...
/**
 * Responsável por estabelecer conexão do Hibernate
 * @author Harlan
 * 
 */
@ApplicationScoped
public class HibernateUtil implements Serializable{
	 ...
	 * Responsável por ler o arquivo de configuração
	 * hibernate.cfg.xml
	 */
	...
	public static Connection getConnection() throws Exception{
		...
		DataSource dtso = (DataSource) context.lookup(JAVA_COMP_ENV_JDBC_DATA_SOURCE);
		return dtso.getConnection();
	}
